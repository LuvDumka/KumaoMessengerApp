...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cumbut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Camera feature temporarily disabled - requires Firebase Storage
    ...
    private void setUserOnlineStatus(boolean isOnline) {
        if (auth.getCurrentUser() != null) {
            DatabaseReference userRef = database.getReference().child("user").child(auth.getCurrentUser().getUid());
